...
const API_BASE_URL =
  import.meta.env.VITE_API_URL || "https://fund-tracker-hppt.onrender.com/api";
...
export const authAPI = {
  ...
  departmentVerifyLoginOTP: (data) =>
    api.post("/auth/department/verify-login-otp", data),
...
export const adminAPI = {
  ...
  getPendingTransactions: (params) =>
    api.get("/transaction/admin/pending", { params }),
  ...
  getTransactionStatistics: (params) =>
    api.get("/transaction/admin/statistics", { params }),
};
...
export const departmentAPI = {
  ...
  getTransactionHistory: (params) =>
    api.get("/transaction/department/history", { params }),
...
export const transactionAPI = {
  ...
  completeTransaction: (transactionId) =>
    api.put(`/transaction/${transactionId}/complete`),
  getTransactionStatistics: (params) =>
    api.get("/transaction/admin/statistics", { params }),
...
export const publicAPI = {
  ...
  getPublicTransactions: (params) =>
    api.get("/public/transactions", { params }),
...
export const currencyAPI = {
  ...
  updateUserPreference: (currency) =>
    api.put("/currency/preference", { currency }),
};
...
export const alertAPI = {
  ...
  resolveAlert: (alertId, comments) =>
    api.put(`/alerts/${alertId}/resolve`, { comments }),

  // Dismiss an alert (Admin only)
  dismissAlert: (alertId, reason) =>
    api.put(`/alerts/${alertId}/dismiss`, { reason }),

  // Get alert details
  getAlertById: (alertId) => api.get(`/alerts/${alertId}`),
};

// Budget Comment API (public, no login required)
export const commentAPI = {
  // Get all approved comments for a budget (public)
  getBudgetComments: (budgetId, params) =>
    api.get(`/comments/budget/${budgetId}`, { params }),

  // Post a new comment (public, no login required)
  postBudgetComment: (budgetId, data) =>
    api.post(`/comments/budget/${budgetId}`, data),

  // Like a comment (public)
  likeComment: (commentId) => api.post(`/comments/${commentId}/like`),

  // Get comment statistics for a budget (public)
  getBudgetCommentStats: (budgetId) =>
    api.get(`/comments/budget/${budgetId}/stats`),
};
